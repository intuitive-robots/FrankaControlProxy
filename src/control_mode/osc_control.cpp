...
// void PInverse(const Eigen::MatrixXd& M, Eigen::MatrixXd& M_inv, double epsilon)
// {
//     Eigen::JacobiSVD<Eigen::MatrixXd> svd(M, Eigen::ComputeFullU | Eigen::ComputeFullV);
//     Eigen::JacobiSVD<Eigen::MatrixXd>::SingularValuesType singular_vals = svd.singularValues();
...
//     this->traj_interpolator.next_step(this->controller_time, desired_pos_EE_in_base_frame,
...
//     tau_d << jacobian_pos.transpose() * (Lambda_pos * (config_.Kp_p * pos_error -
//                                                        config_.Kd_p * (jacobian_pos * dq))) +
//                  jacobian_ori.transpose() *
//                      (Lambda_ori * (config_.Kp_r * ori_error - config_.Kd_r * (jacobian_ori * dq)));
...
//     std::cout << "[OSC] Control started with initial pose as setpoint."
//               << pos_EE_in_base_frame.transpose() << std::endl;
// }