...
bool JointPositionMotionGenerator::calculateDesiredValues(double time, JointPositionMotionGenerator::Vector7d* delta_q_d) const {
...
void JointPositionMotionGenerator::calculateSynchronizedValues() {
    ...
    JointPositionMotionGenerator::Vector7d delta_t_2 = JointPositionMotionGenerator::Vector7d::Zero();
    JointPositionMotionGenerator::Vector7d t_1 = JointPositionMotionGenerator::Vector7d::Zero();
    JointPositionMotionGenerator::Vector7d delta_t_2_sync = JointPositionMotionGenerator::Vector7d::Zero();
    JointPositionMotionGenerator::Vector7i sign_delta_q;
    sign_delta_q << delta_q_.cwiseSign().cast<int>();
