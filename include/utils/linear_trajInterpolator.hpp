...
class LinearJointPositionTrajInterpolator {
 ...
 public:
  ...
  // Copy assignment operator
  inline LinearJointPositionTrajInterpolator& operator=(const LinearJointPositionTrajInterpolator& other) {
    if (this != &other) {
      std::lock_guard<std::mutex> lock(mutex_);
      q_start_ = other.q_start_;
      q_goal_ = other.q_goal_;
  ...
  // Move assignment operator
  inline LinearJointPositionTrajInterpolator& operator=(LinearJointPositionTrajInterpolator&& other) noexcept {
    if (this != &other) {
      std::lock_guard<std::mutex> lock(mutex_);
      q_start_ = std::move(other.q_start_);
      q_goal_ = std::move(other.q_goal_);
